...
**95% of the catalogue is intermittent or lumpy.** This genuinely is a
...
1. **Overall, LightGBM crushes the classical methods** (0.66 vs ~1.06 WRMSSE — a
...
covariates, and little history**, where a robust size-÷-interval rate is genuinely
hard to beat and needs almost no data. That's a large slice of real supply chains.
